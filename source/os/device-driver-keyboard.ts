...
module TSOS {
    ...
    export class DeviceDriverKeyboard extends DeviceDriver {
         ...
         */
        krnKbdDispatchKeyPress(params): void {
            // Parse the params.    
            ...
            if (((keyCode >= CharCode.A) && (keyCode <= CharCode.Z)) ||   // A..Z
            ...
            } else if (((keyCode >= CharCode.Zero) && (keyCode <= CharCode.Nine) && !isShifted)
                        || (keyCode === CharCode.Space) || (keyCode === CharCode.Enter)) {
                ...
                if (this.characterArray.length > 0) {
                    ...
                    const previousChar = this.characterArray[this.characterArray.length - 1];
         ...
         * @param keyCode 
         */
        basicKeyPress(keyCode: number): void {
